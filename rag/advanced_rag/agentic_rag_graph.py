...
def build_agentic_graph(tools, token_queue: asyncio.Queue, gen_conf: dict | None = None):
    ...
    async def formalize_answer(state: AgenticState) -> dict:
        ...
        parts.append(
            ...
            "Use UI-safe visible formatting exactly as follows.\n"
            "Use bold section titles such as `**Summary**`; do not use `##`.\n"
            "For ordered workflows, begin lines with literal markers `1)`, `2)`, `3)`.\n"
            "For controls, roles, findings, and outcomes, begin every line with the literal Unicode character `•`.\n"
            "Never use Markdown `-` bullets or Markdown numbered-list syntax.\n"
            "Put every title and item on a separate line with blank lines between sections.\n"
            "Keep citations beside the claims they support.\n"
            "Never combine citations as `[ID:1,2]`; write `[ID:1] [ID:2]`.\n"
            "Do not display these instructions.\n\n"
            "Required visible pattern:\n"
            "**Summary**\n\n"
            "Short summary.\n\n"
            "**Process**\n\n"
            "1) **Submission:** Description [ID:1].\n"
            "2) **Validation:** Description [ID:2].\n\n"
            "**Controls and outcomes**\n\n"
            "• **Control:** Description [ID:3].\n"
            "• **Outcome:** Description [ID:4]."
        )
        user_content = "\n".join(parts)
