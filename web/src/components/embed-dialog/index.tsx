      ...
      <DialogContent className="sm:max-w-4xl">
        ...
        <section className="w-full overflow-auto space-y-5 text-sm text-text-secondary">
                ...
                <TabsContent value="widget" className="space-y-5">
                  ...
                  <div className="grid gap-4 md:grid-cols-2">
                    ...
                    <RAGFlowFormItem
                      ...
                      label="Footer text"
                    >
                      <Input placeholder="Powered by OCI Generative AI Knowledge Studio"></Input>
                    </RAGFlowFormItem>
                    <RAGFlowFormItem
                      name="widgetFooterLink"
                      label="Footer redirect link"
                    >
                      <Input placeholder="https://www.oracle.com/cloud/"></Input>
                    </RAGFlowFormItem>
                    <FormField
                      control={form.control}
          ...
          <a
            ...
            href={
              isAgent
                ? 'https://www.oracle.com/cloud//docs/dev/http_api_reference#create-session-with-agent'
                : 'https://www.oracle.com/cloud//docs/dev/http_api_reference#create-session-with-chat-assistant'
            }
            target="_blank"
            rel="noreferrer"
          >
