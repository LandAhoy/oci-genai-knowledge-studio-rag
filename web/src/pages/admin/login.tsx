      ...
      <div className="relative h-max min-h-[100vh]">
        ...
        <div className="absolute top-3 left-0 w-full">
          <div className="absolute mt-12 ml-12 flex items-center">
            <img className="h-8 w-28 object-contain mr-5" src="/oracle-logo.png" alt="OCI Generative AI Knowledge Studio logo" />
            <span className="text-xl font-bold">OCI Generative AI Knowledge Studio</span>
          </div>
