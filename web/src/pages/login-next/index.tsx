...
const Login = () => {
  ...
  return (
    <>
      <Spotlight opcity={0.4} coverage={60} color={'rgb(255, 80, 70)'} />
      <Spotlight
        opcity={0.3}
        coverage={12}
        X={'10%'}
        ...
        <div className="z-20 absolute top-3 flex flex-col items-center mb-12 w-full text-text-primary">
          <div className="flex items-center mb-4 w-full pl-10 pt-10 ">
            <div className="w-12 h-12 p-2 rounded-lg flex items-center justify-center mr-3">
              <img
                src={'/oracle-logo.png'}
                alt="OCI Generative AI Knowledge Studio logo"
                className="h-8 w-28 object-contain mr-[12] cursor-pointer"
              />
            </div>
            <div className="text-xl font-bold self-center">OCI Generative AI Knowledge Studio</div>
          </div>
